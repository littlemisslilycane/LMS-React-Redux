...
<div className="tab-content">
                               ...
                               <div className="tab-pane w-98 fade show active " id="v-pills-topic1" role="tabpanel">
                                   ...
                                   <div className="border">
                                       <div className="row">
                                           <div className="col-5">
                                               <h3><label>Heading Widget</label></h3></div>
                                           <div className="col-2">
                                               <button type="button" className="btn btn-warning"><i className="fa fa-arrow-up"></i></button>
                                               <button type="button" className="btn btn-warning"><i className="fa fa-arrow-down"></i></button>
                                           </div>
                                           <div className="col-5 d-flex flex-row">
                                               <select className="form-control w-75">
                                                   <option value="Heading" selected>Heading</option>
                                               </select>
                                               <i className="fa pl-4 fa-window-close fa-2x text-danger" aria-hidden="true"></i>
